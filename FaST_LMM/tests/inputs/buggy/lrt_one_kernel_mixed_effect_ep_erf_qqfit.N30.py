distributable = FastLmmSet(
    ...
    altset_list = 'datasets/set_input.23_11.txt',
    covarfile  =  None,
    filenull = None,   
    autoselect = False,
    mindist = 0,
    ...
    outfile = 'tmp/lrt_one_kernel_mixed_effect_ep_erf_qqfit.N30.txt',
    forcefullrank=False,
    qmax=0.1,      #use the top 10% of null distrib test statistics to fit the null distribution
    write_lrtperm=True,
    datestamp=None,
    nullModel={'effect':'mixed', 'link':'erf',
               'approx':'ep', 'penalty':None},
    altModel={'effect':'mixed', 'link':'erf',
              'approx':'ep', 'penalty':None},
